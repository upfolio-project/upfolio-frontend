...
import {useGetPathRoute} from "@/shared/hooks/useGetPathRoute/useGetPathRoute";

export const useAppDispatch = () => useDispatch<AppDispatch>();
export const useAppSelector: TypedUseSelectorHook<RootState> = useSelector;
export {useRedirectAuthToPersonalPage, useRedirectNotAuthToLoginPage, useGetMe, useGetPathRoute};