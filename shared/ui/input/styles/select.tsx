...
import {borders, colors, fonts, shadows, sizes} from "@/shared/styles";
    ...
    return (
        <FormControlStyled fullWidth>
            ...
            <SelectStyled
                ...
                labelId={id}
            >
                {items.map(item => <MenuItemStyled value={item.value as string}
                                                   key={item.key}>{item.content}</MenuItemStyled>)}
            </SelectStyled>
        </FormControlStyled>
    );
};
